...
declare module "vue-router/auto-routes" {
  ...
  */
  export interface RouteNamedMap {
    ...
    "AgentConfig": RouteRecordInfo<"AgentConfig", "/agent/config", Record<never, never>, Record<never, never>>;
    ...
    "ManageAgent": RouteRecordInfo<"ManageAgent", "/manage/agent", Record<never, never>, Record<never, never>>;
    "ManageApi": RouteRecordInfo<"ManageApi", "/manage/api", Record<never, never>, Record<never, never>>;
    "ManageLog": RouteRecordInfo<"ManageLog", "/manage/log", Record<never, never>, Record<never, never>>;
    ...
    "Medic": RouteRecordInfo<"Medic", "/medic", Record<never, never>, Record<never, never>>;
    "MedicalDiseaseList": RouteRecordInfo<"MedicalDiseaseList", "/medical/disease-list", Record<never, never>, Record<never, never>>;
    "MedicalExecutionDetailId": RouteRecordInfo<"MedicalExecutionDetailId", "/medical/execution-detail/:id", { id: ParamValue<true> }, { id: ParamValue<false> }>;
