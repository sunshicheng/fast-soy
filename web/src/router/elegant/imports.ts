...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  manage_agent: () => import("@/views/manage/agent/index.vue"),
  ...
  "medical_disease-list": () => import("@/views/medical/disease-list/index.vue"),
  "medical_execution-detail": () => import("@/views/medical/execution-detail/[id].vue"),
